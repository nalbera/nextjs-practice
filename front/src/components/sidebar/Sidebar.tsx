  ...
  return (
    <div className='flex flex-col w-56 bg-gray-200 rounded-r-3xl overflow-hidden mt-9'>
        ...
        <ul className='flex flex-col py-4'>
            ...
            <li>
                <Link href="/dashboard/orders" className='flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800'>
